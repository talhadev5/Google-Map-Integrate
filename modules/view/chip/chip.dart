...
class ChipPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChipLogic>(builder: (controller) {
      return Scaffold(
        backgroundColor: AppColors.geryColorLight,
        body: SafeArea(
          child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: controller.selectedChipIndex == index
                                ...
                                : AppColors.white, // Default background color
            ...
            children: [
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: controller.selectedChipIndex == -1
                      ? null // Disable button when no chip is selected
                      : () {
